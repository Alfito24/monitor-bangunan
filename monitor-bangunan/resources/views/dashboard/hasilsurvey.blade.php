...
@endsection
@section('js')
    <script src="js/dashboard/demografi.js"></script>
        ...
        <div class="card-body">
            <div class="cycle-tab-container">
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="demografi" role="tabpanel" aria-labelledby="profile-tab">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-9">
                                    <div class="box">
                                        <div class="container">
                                            <h3 class="mb-3">Demografi Responden</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
