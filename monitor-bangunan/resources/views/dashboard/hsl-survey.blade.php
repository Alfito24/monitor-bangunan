    ...
    <div class="container survey-seluruh">
        <nav class="mt-5">
            <div class="nav nav-tabs mt-3" id="nav-tab" role="tablist">
                ...
                <button class="nav-link" id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#rinciann"
                    type="button" role="tab" aria-controls="nav-contact" aria-selected="false">Rincian
                </button>
        ...
        <div class="tab-content mt-3" id="nav-tabContent">
            ...
            <div class="tab-pane fade" id="rinciann" role="tabpanel" aria-labelledby="nav-contact-tab">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="box">
